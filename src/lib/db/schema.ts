...
export const populatedPlaces = pgTable(
  "populated_places",
  {
  ...
  (table) => [
    index("sidx_populated_places_geom").using(
      "gist",
...
export const districts = pgTable(
  ...
  (table) => [
    index("sidx_districts_geom").using(
      "gist",
      table.geom.asc().nullsLast().op("gist_geometry_ops_2d")
    ),
  ]
...
export const districtSubdivisions = pgTable(
  ...
  (table) => [
    index("sidx_district_subdivisions_geom").using(
      "gist",
      table.geom.asc().nullsLast().op("gist_geometry_ops_2d")
    ),
  ]
...
export const educationFacilities = pgTable(
  ...
  (table) => [
    index("sidx_education_facilities_geom").using(
      "gist",
      table.geom.asc().nullsLast().op("gist_geometry_ops_2d")
    ),
  ]
