...
export default function Map({
      ...
      <MapContainer
        ...
        whenReady={() => {
          ...
          if (mapElement && "leaflet" in window) {
            ...
            mapRef.current =
              window.L.DomUtil.get(mapElement)?.getContainer()?._leaflet_map
          }
        }}
        zoomControl={true}
  ...
  return <div className="h-full w-full">{mapContainer}</div>
}
