...
interface SchoolCoverageMapProps {
  // Add any props if needed
}

export function SchoolCoverageMap({}: SchoolCoverageMapProps) {
  ...
  const unservedCommunities = [
    ...
    { id: 2, name: 'Village Y', lat: -13.970, lng: 33.760, population: 1800 },
  ];
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Schools Mapped</CardTitle>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Unserved Communities</CardTitle>
            <Users className="h-4 w-4 text-muted-foreground" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">{totalUnservedCommunities}</div>
            <p className="text-xs text-muted-foreground">Communities without school access</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Population Unserved</CardTitle>
            <Users className="h-4 w-4 text-muted-foreground" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">{totalPopulationUnserved.toLocaleString()}</div>
            <p className="text-xs text-muted-foreground">People without school access</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Coverage Radius</CardTitle>
            <MapPin className="h-4 w-4 text-muted-foreground" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">{coverageRadius} km</div>
            <p className="text-xs text-muted-foreground">School coverage distance</p>
          </CardContent>
        </Card>
      </div>
        ...
        <div className="space-y-4">
            ...
            <CardContent className="space-y-4">
              <div>
                <div className="flex items-center justify-between mb-2">
                  <label className="text-sm font-medium">Coverage Radius: {coverageRadius} km</label>
                </div>
                <Slider
                  min={1}
                  max={20}
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                <div>
                  <h4 className="text-sm font-medium mb-2">Within {coverageRadius}km coverage:</h4>
                  <div className="space-y-1">
                    ...
                    <div className="flex justify-between">
                      <span className="text-sm text-muted-foreground">Population covered:</span>
                ...
                <div>
                  <h4 className="text-sm font-medium mb-2">Outside {coverageRadius}km coverage:</h4>
                  <div className="space-y-1">
                    <div className="flex justify-between">
                      <span className="text-sm text-muted-foreground">Communities unserved:</span>
                      <span className="font-medium text-destructive">{totalUnservedCommunities}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-sm text-muted-foreground">Population unserved:</span>
                      <span className="font-medium text-destructive">{totalPopulationUnserved.toLocaleString()}</span>
                    </div>
                  </div>
                </div>
              </div>
